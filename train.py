...
class Keras(BaseAlgo):
    ...
    def predict(self, X):
        ...
        return self.model.predict_generator(batch_generator(X, batch_size=800), val_samples=X.shape[0]).reshape(
            (X.shape[0],))
...
presets = {
    ...
    'xgbf-ce-6': {
        ...
        'feature_builders': [
            CategoricalAlphaEncoded(
                combinations=[('cat103', 'cat111'), ('cat2', 'cat6'), ('cat87', 'cat11'), ('cat103', 'cat4'),
                              ('cat80', 'cat103'), ('cat73', 'cat82'), ('cat12', 'cat72'), ('cat80', 'cat12'),
                              ('cat111', 'cat5'), ('cat2', 'cat111'), ('cat80', 'cat57'), ('cat80', 'cat79'),
                              ('cat1', 'cat82'), ('cat11', 'cat13')]
            )],
        'y_transform': y_norm,
        'n_bags': 4,
        'model': Xgb({
        ...
        'feature_builders': [
            CategoricalAlphaEncoded(
                combinations=[('cat103', 'cat111'), ('cat2', 'cat6'), ('cat87', 'cat11'), ('cat103', 'cat4'),
                              ('cat80', 'cat103'), ('cat73', 'cat82'), ('cat12', 'cat72'), ('cat80', 'cat12'),
                              ('cat111', 'cat5'), ('cat2', 'cat111'), ('cat80', 'cat57'), ('cat80', 'cat79'),
                              ('cat1', 'cat82'), ('cat11', 'cat13'), ('cat79', 'cat81'), ('cat81', 'cat13'),
                              ('cat9', 'cat73'), ('cat2', 'cat81'), ('cat80', 'cat111'), ('cat79', 'cat111'),
                              ('cat72', 'cat1'), ('cat23', 'cat103'), ('cat89', 'cat13'), ('cat57', 'cat14'),
                              ('cat80', 'cat81'), ('cat81', 'cat11'), ('cat9', 'cat103'), ('cat23', 'cat36')]
            )],
        'y_transform': y_log_ofs(200),
        'n_bags': 4,
        'model': Xgb({
        ...
        'feature_builders': [
            CategoricalAlphaEncoded(
                combinations=itertools.combinations(
                    'cat80,cat87,cat57,cat12,cat79,cat10,cat7,cat89,cat2,cat72,cat81,cat11,cat1,cat13,cat9,cat3,cat16,cat90,cat23,cat36,cat73,cat103,cat40,cat28,cat111,cat6,cat76,cat50,cat5,cat4,cat14,cat38,cat24,cat82,cat25'.split(
                        ','), 2)
            )],
        'y_transform': y_log_ofs(200),
        'n_bags': 6,
    ...
    'xgbf-ce-14': {
        ...
        'feature_builders': [
            CategoricalAlphaEncoded(
                combinations=[('cat101', 'cat80'), ('cat79', 'cat80'), ('cat12', 'cat80'), ('cat101', 'cat81'),
                              ('cat12', 'cat81'), ('cat12', 'cat79'), ('cat57', 'cat79'), ('cat1', 'cat80'),
                              ('cat101', 'cat79'), ('cat1', 'cat81')]
            )],
    ...
    'libfm-ce': {
        'features': ['numeric_scaled', 'categorical_encoded'],
        'y_transform': y_log,
        'model': LibFM(params={
            'method': 'sgd',
            'learn_rate': 0.0001,
    ...
    'nn1': {
        'features': ['numeric', 'categorical_encoded'],
        'model': Keras(nn_mlp, {'l1': 1e-3, 'l2': 1e-3, 'n_epoch': 100, 'batch_size': 48, 'layers': [400, 200],
                                'dropouts': [0.4, 0.2]}),
    },
    ...
    'nn-cd': {
        'features': ['numeric_scaled', 'categorical_dummy'],
        'n_bags': 2,
        'model': Keras(nn_mlp, lambda: {'l1': 1e-5, 'l2': 1e-5, 'n_epoch': 80, 'batch_size': 128, 'layers': [400, 200],
                                        'dropouts': [0.4, 0.2], 'optimizer': Adadelta(),
                                        'callbacks': [ExponentialMovingAverage(save_mv_ave_model=False)]}, scale=False),
    },
    ...
    'nn-cd-2': {
        ...
        'n_bags': 2,
        'model': Keras(nn_mlp,
                       lambda: {'l1': 2e-5, 'l2': 2e-5, 'n_epoch': 40, 'batch_size': 128, 'layers': [400, 200, 100],
                                'dropouts': [0.5, 0.4, 0.2], 'batch_norm': True, 'optimizer': Adadelta(),
                                'callbacks': [ExponentialMovingAverage(save_mv_ave_model=False)]}, scale=False),
    },
    ...
    'nn-cd-3': {
        ...
        'y_transform': y_log_ofs(200),
        'n_bags': 4,
        'model': Keras(nn_mlp_2, lambda: {'n_epoch': 55, 'batch_size': 128, 'layers': [400, 200, 50],
                                          'dropouts': [0.4, 0.25, 0.2], 'batch_norm': True, 'optimizer': Adadelta(),
    ...
    'nn-cd-clrbf-2': {
        ...
        'y_transform': y_log_ofs(200),
        'n_bags': 4,
        'model': Keras(nn_mlp_2, lambda: {'n_epoch': 70, 'batch_size': 128, 'layers': [400, 200, 50],
                                          'dropouts': [0.4, 0.25, 0.2], 'batch_norm': True, 'optimizer': Adadelta(),
                                          'callbacks': [ExponentialMovingAverage(save_mv_ave_model=False)]},
                       scale=False),
    },
    ...
    'nn-cd-clrbf-3': {
        ...
        'y_transform': y_log_ofs(200),
        'n_bags': 4,
        'model': Keras(nn_mlp_2, lambda: {'l1': 1e-6, 'n_epoch': 60, 'batch_size': 128, 'layers': [400, 200, 80],
                                          'dropouts': [0.4, 0.3, 0.2], 'batch_norm': True, 'optimizer': Adadelta(),
                                          'callbacks': [ExponentialMovingAverage(save_mv_ave_model=False)]},
                       scale=False),
    },
    ...
    'nn-cd-clrbf-4': {
        ...
        'n_bags': 4,
        'model': Keras(nn_mlp_2,
                       lambda: {'l1': 1e-5, 'l2': 1e-5, 'n_epoch': 30, 'batch_size': 128, 'layers': [400, 200, 100],
                                'dropouts': [0.5, 0.3, 0.2], 'batch_norm': True, 'optimizer': Adadelta(),
                                'callbacks': [ExponentialMovingAverage(save_mv_ave_model=False)]}, scale=False),
    },
    ...
    'nn-cd-clrbf-5': {
        ...
        'n_bags': 8,
        'model': Keras(nn_mlp_2,
                       lambda: {'n_epoch': 70, 'batch_size': 128, 'layers': [400, 200, 70], 'dropouts': [0.5, 0.3, 0.2],
    ...
    'nn-cd-clrbf-6': {
        ...
        'y_transform': y_log_ofs(200),
        'n_bags': 6,
        'model': Keras(nn_mlp_2, lambda: {'n_epoch': 80, 'batch_size': 128, 'layers': [350, 170, 70],
                                          'dropouts': [0.6, 0.3, 0.15], 'batch_norm': True,
    ...
    'nn-cd-clrbf-7': {
        'features': ['numeric_scaled', 'categorical_dummy', 'cluster_rbf_25', 'cluster_rbf_50', 'cluster_rbf_75',
                     'cluster_rbf_100'],
        'y_transform': y_log_ofs(200),
        'n_bags': 8,
        'model': Keras(nn_mlp_2,
                       lambda: {'n_epoch': 55, 'batch_size': 128, 'layers': [400, 200, 70], 'dropouts': [0.5, 0.3, 0.2],
                                'batch_norm': True, 'optimizer': Adadelta(),
                                'callbacks': [ExponentialMovingAverage(save_mv_ave_model=False)]}, scale=False),
    },
    ...
    'nn-svd-2': {
        ...
        'n_bags': 2,
        'model': Keras(nn_mlp_2,
                       lambda: {'l1': 1e-7, 'l2': 1e-7, 'n_epoch': 55, 'batch_size': 128, 'layers': [400, 200, 50],
                                'dropouts': [0.4, 0.2, 0.2], 'batch_norm': True, 'optimizer': Adadelta(),
                                'callbacks': [ExponentialMovingAverage(save_mv_ave_model=False)]}, scale=False),
    },
    ...
    'nn-svd-cd-clrbf-1': {
        ...
        'y_transform': y_log_ofs(200),
        'n_bags': 4,
        'model': Keras(nn_mlp_2, lambda: {'l1': 1e-6, 'n_epoch': 70, 'batch_size': 128, 'layers': [400, 150, 60],
                                          'dropouts': [0.4, 0.25, 0.25], 'batch_norm': True,
    ...
    'nn-svd-cd-clrbf-2': {
        'features': ['svd', 'categorical_dummy', 'cluster_rbf_25', 'cluster_rbf_50', 'cluster_rbf_75',
                     'cluster_rbf_100'],
        'n_bags': 4,
        'model': Keras(nn_mlp_2, lambda: {'l1': 1e-5, 'n_epoch': 45, 'batch_size': 128, 'layers': [400, 200, 200],
                                          'dropouts': [0.4, 0.4, 0.3], 'batch_norm': True,
                                          'optimizer': SGD(3e-3, momentum=0.8, nesterov=True, decay=2e-4),
                                          'callbacks': [ExponentialMovingAverage(save_mv_ave_model=False)]},
                       scale=False),  # Adam(decay=1e-6)
    },
    ...
    'nn-svd-cd-clrbf-3': {
        ...
        'y_transform': y_pow(0.25),
        'n_bags': 4,
        'model': Keras(nn_mlp_2, lambda: {'l1': 1e-6, 'n_epoch': 60, 'batch_size': 128, 'layers': [400, 150, 60],
                                          'dropouts': [0.4, 0.25, 0.25], 'batch_norm': True,
                                          'optimizer': Adam(decay=1e-5),
                                          'callbacks': [ExponentialMovingAverage(save_mv_ave_model=False)]},
                       scale=False),
    ...
    'nn-cm-tst': {
        ...
        'model': Keras(nn_mlp, lambda: {'l1': 1e-5, 'l2': 1e-5, 'n_epoch': 80, 'batch_size': 128, 'layers': [400, 200],
                                        'dropouts': [0.4, 0.2], 'optimizer': Adadelta(),
                                        'callbacks': [ExponentialMovingAverage(save_mv_ave_model=False)]}, scale=True),
    },
    ...
    'l2-nn': {
        ...
        'n_bags': 4,
        'model': Keras(nn_mlp, lambda: {'l1': 1e-5, 'l2': 1e-5, 'n_epoch': 30, 'batch_size': 128, 'layers': [50],
                                        'dropouts': [0.1],
                                        'optimizer': SGD(1e-3, momentum=0.8, nesterov=True, decay=3e-5),
                                        'callbacks': [ExponentialMovingAverage(save_mv_ave_model=False)]}),
    },
    ...
    'l2-nn-2': {
        'predictions': l1_predictions,
        'n_bags': 6,
        'model': Keras(nn_mlp, lambda: {'l1': 1e-5, 'l2': 1e-5, 'n_epoch': 40, 'batch_size': 128, 'layers': [200, 50],
                                        'dropouts': [0.15, 0.1],
                                        'optimizer': SGD(1e-3, momentum=0.8, nesterov=True, decay=3e-5),
                                        'callbacks': [ExponentialMovingAverage(save_mv_ave_model=False)]}),
    },
    ...
    'l2-nn-3': {
        'predictions': l1_predictions,
        'n_bags': 4,
        'model': Keras(nn_mlp, lambda: {'l1': 3e-6, 'l2': 3e-6, 'n_epoch': 70, 'batch_size': 128, 'layers': [200, 100],
                                        'dropouts': [0.15, 0.15],
                                        'optimizer': SGD(1e-4, momentum=0.9, nesterov=True, decay=3e-5),
                                        'callbacks': [ExponentialMovingAverage(save_mv_ave_model=False)]}),
    },
    ...
    'l2-nn-4': {
        'predictions': l1_predictions,
        'n_bags': 6,
        'model': Keras(nn_mlp, lambda: {'l1': 1e-5, 'l2': 1e-5, 'n_epoch': 30, 'batch_size': 128, 'layers': [200, 50],
                                        'dropouts': [0.15, 0.1],
                                        'optimizer': SGD(1e-4, momentum=0.8, nesterov=True, decay=1e-5),
                                        'callbacks': [ExponentialMovingAverage(save_mv_ave_model=False)]}),
    },
    ...
    'l2-nn-5': {
        'predictions': l1_predictions,
        'n_bags': 4,
        'model': Keras(nn_mlp, lambda: {'l1': 3e-6, 'l2': 3e-6, 'n_epoch': 50, 'batch_size': 128, 'layers': [200, 100],
                                        'dropouts': [0.15, 0.15],
    ...
    'l2-gb': {
        'predictions': l1_predictions,
        'n_bags': 2,
        'model': Sklearn(GradientBoostingRegressor(loss='lad', n_estimators=425, learning_rate=0.05, subsample=0.65,
                                                   min_samples_leaf=9, max_depth=5, max_features=0.35)),
        'param_grid': {'n_estimators': (200, 500), 'max_depth': (1, 8), 'max_features': (0.1, 0.8),
                       'min_samples_leaf': (1, 20), 'subsample': (0.5, 1.0), 'learning_rate': (0.01, 0.3)},
    },

    'l2-gb-2': {
        'predictions': l1_predictions,
        'n_bags': 4,
        'model': Sklearn(GradientBoostingRegressor(loss='lad', n_estimators=425, learning_rate=0.04, subsample=0.65,
                                                   min_samples_leaf=9, max_depth=5, max_features=0.35)),
        'param_grid': {'n_estimators': (200, 500), 'max_depth': (1, 8), 'max_features': (0.1, 0.8),
                       'min_samples_leaf': (1, 20), 'subsample': (0.5, 1.0), 'learning_rate': (0.01, 0.3)},
    },
    ...
    'l2-knn': {
        ...
        'y_transform': y_log_ofs(200),
        'model': Sklearn(
            Pipeline([('sc', StandardScaler()), ('est', KNeighborsRegressor(100, 'distance', n_jobs=-1))])),
        'sample': 0.2,
        'n_bags': 4,
    },
    ...
    'l2-svd-knn': {
        ...
        'prediction_transform': lambda x: np.log(x + 200),
        'y_transform': y_log_ofs(200),
        'model': Sklearn(Pipeline([('sc', StandardScaler()), ('svd', TruncatedSVD(10)),
                                   ('est', KNeighborsRegressor(100, 'distance', n_jobs=-1))])),
        'sample': 0.95,
        'n_bags': 4,
    },
    ...
    'l3-nn': {
        ...
        'n_bags': 4,
        'model': Keras(nn_lr, lambda: {'l2': 1e-5, 'n_epoch': 1, 'batch_size': 128,
                                       'optimizer': SGD(lr=2.0, momentum=0.8, nesterov=True, decay=1e-4)}),
        'agg': np.mean,
    },
    ...
    'l3-nn': {
        'predictions': l2_predictions,
        'n_bags': 4,
        'model': Keras(nn_lr, lambda: {'l1': 1e-5, 'l2': 1e-5, 'n_epoch': 30, 'batch_size': 128,
                                       'optimizer': SGD(3e-2, momentum=0.8, nesterov=True, decay=3e-5),
                                       'callbacks': [ExponentialMovingAverage(save_mv_ave_model=False)]}),
    },
}
...
test_fulltrain_p = pd.Series(y_aggregator(y_inv_transform(test_fulltrain_p), axis=1),
                             index=Dataset.load_part('test', 'id'))
